...
//    printImage(&input);
    ...
    // implement algorithm
    image output1 = applyAlgorithm(&input, algorithm);
    printImage(&output1); printf("\n");
    image output2 = applyAlgorithm(&output1, algorithm);
    printImage(&output2); printf("\n");
    int cnt = countLitPixels(&output2);
